...
// this is database working finally
  ...
  //var query = firebase.database().ref('year/2019/month/january/date/one/time/one/location').orderByKey();
  var query = firebase.database().ref(linkurl).orderByKey();
  query.once("value")
